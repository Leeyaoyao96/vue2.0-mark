  ...
  export default {
    ...
    methods: {
      ...
      getPrice () {
        ...
        this.$http.post('https://easy-mock.com/mock/5a5ef40c6c1e0a3235e8cf8b/getPrice', reqParams)
          .then((res) => {
      ...
      confirmBuy () {
        ...
        this.$http.post('https://easy-mock.com/mock/5a5ef40c6c1e0a3235e8cf8b/createOrder', reqParams)
          .then((res) => {
